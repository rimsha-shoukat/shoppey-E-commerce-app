  ...
  return(
    <>
     <Routes>
      ...
      <Route path="/AllProducts/:new" element={<AllProducts />} />
      <Route path="/AllProducts/:collection" element={<AllProducts />} />
      <Route path="/AllProducts/:trend" element={<AllProducts />} />
      <Route path="/AllProducts/:best" element={<AllProducts />} />
      <Route path="/AllProducts/:trend" element={<AllProducts />} />
