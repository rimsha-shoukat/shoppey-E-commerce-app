        ...
        <>
          <section className="relative w-[100%] h-[88vh] overflow-hidden">
            ...
            <div className="relative w-[100%] h-[100%] flex flex-row max-[710px]:flex-col items-center justify-between text-[#251201]">
                {/* content section */}
                <section className="flex flex-col items-start justify-center gap-4 pl-[4rem] max-[800px]:pl-[2rem] w-[50%] max-[710px]:w-[100%] max-[710px]:pt h-auto select-none font-serif">
