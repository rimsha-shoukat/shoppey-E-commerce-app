    ...
    return(
        <>
           ...
           <div className="relative flex flex-col gap-[2rem] py-[2rem] w-[100vw] h-[100vh]">
                ...
                <main className="flex flex-row items-center justify-center gap-[5rem] w-[100%] h-auto">
                    <section className="w-[50%] h-auto flex items-center justify-center">
                        ...
                        <h1 className="text-[3.5rem] font-semibold font-serif text-nowrap se">Picked Every Item <br/> With Care, You <br/> Must Try</h1>
                    ...
                    <img className="w-[40%] h-[86vh] rounded-bl-[10rem]" src={sideImg} alt="side-img" />
                </main>
           </div>
           </div>
        </>
