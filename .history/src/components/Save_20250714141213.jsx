                    ...
                    <div className="w-auto flex flex-row items-center justify-start py-6 max-[6000px]:py-2 gap-4 max-[6000px]:gap-2 border-t-2 border-t-gray-400">
                        ...
                        <div className="flex flex-row max-[600px]:flex-col max-[600px]:gap-4 items-center justify-between gap-[3rem] ">
                            ...
                            <div className="flex flex-row items-start justify-start gap-4">
                                <button className="px-[1rem] py-[0.5rem] rounded-md cursor-pointer border-none max-[400px]:px-[0.5rem] max-[400px] bg-blue-700 text-nowrap">Add to cart</button>
                                <button className="px-[1rem] py-[0.5rem] rounded-md cursor-pointer border-none max-[400px]:px-[0.5rem] max-[400px] bg-red-600">Remove</button>
                            </div>
                        </div>  
                    </div>
                </section>
