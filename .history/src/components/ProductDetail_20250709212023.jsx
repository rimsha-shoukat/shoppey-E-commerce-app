                 ...
                 <section className="grid grid-cols-2 items-center justify-center w-[60%] h-auto border-2 border-gray-300 rounded-lg gap-[1rem] bg-[#eee2ca]">
                    ...
                    <div className="cols-span-1 h-auto flex flex-col items-start justify-start p-6 font-white">
                        ...
                        <div className="flex flex-row items-center justify-center gap-[1rem]">
                            <button className="w-[2.5rem] h-[1.5rem] rounded-full shadow-md cursor-pointer">XS</button>
                            <button className="w-[2.5rem] h-[1.5rem] rounded-full shadow-md cursor-pointer">S</button>
                            <button className="w-[2.5rem] h-[1.5rem] rounded-full shadow-md cursor-pointer">M</button>
                            <button className="w-[2.5rem] h-[1.5rem] rounded-full shadow-md cursor-pointer">L</button>
                        </div>
                        <div className="flex flex-row items-center justify-center gap-[1rem]">
