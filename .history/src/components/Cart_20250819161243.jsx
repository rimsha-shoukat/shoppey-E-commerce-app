    ...
    return (
        <section className="w-[100%] h-auto flex flex-col items-center justify-center">
           {cartItemsList.map((item) => (
            <div key={item.id} className="w-[100%] flex flex-row items-center justify-center py-6 max-[350px]:py-2 gap-2 border-t-2 border-t-gray-400">
                        <img className="w-[5rem] h-[5rem] rounded-sm" src={item.src} />
                        <div className="flex flex-row items-start justify-between gap-2 max-[500px]:flex-col">
                            <div className="flex flex-col items-start justify-start gap-2">
                                <h1 className="font-bold text-[1.2rem] leading-7 max-[350px]:text-[0.95rem] w-[20rem] max-[760px]:w-[15rem] max-[500px]:w-[11rem] max-[760px]:text-[1rem]">{item.name}</h1>
