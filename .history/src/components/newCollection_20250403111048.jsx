...
function newCollection(){
    return(
        <>
            <div className="relative w-[100%] flex flex-col items-center justify-center my-[3rem]">
                <section className="w-[50%] h-auto flex flex-row items-start justify-center">
                ...
                <section className="absolute bottom-0 right-0 bg-red-900 w-[50%]">
                        <div>
                            <h1>hello</h1>
                            <p>hello</p>
                        </div>
