...
function Product(){
    return(
        <>
         <div className="w-[100%] h-auto p-[4rem] max-[430px]:p-[1] flex flex-col items-center justify-center font-serif select-none">
            <h1 className="font-bold text-[clamp(2rem,5vw,5rem)]">Our Product</h1>
            {/* categories button section */}
            <section className="flex flex-row items-center justify-center gap-4 leading-4 w-[100%] h-[2rem]">
