...
const AllProducts = () => {
  return (
    <section className="w-[100%] h-auto p-0 m-0 font-serif flex flex-col items-center justify-center overflow-hidden">

    <section className="flex flex-row items-center justify-between w-[100%] h-auto">
        <Link to="/">
          <button className="font-extrabold font-serif text-lg cursor-pointer hover:text-gray-500">shoppey</button>
        </Link>
    ...
    <section className="flex flex-col items-center justify-center w-[100%] border-none rounded-[1rem] h-auto bg-linear-to-l from-[#dd957a] to-[#eee2ca] gap-2">
