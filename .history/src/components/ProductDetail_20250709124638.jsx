        ...
        <>
            <div className="w-screen h-auto font-serif">
                <section className="flex flex-row items-center py-2 px-6 justify-between w-[100%] h-auto mb-[1rem]">
                    <Link to="/">
                      <button className="font-extrabold font-serif text-xl cursor-pointer hover:text-gray-500 bg-gray-400">shoppey</button>
                    </Link>
                 ...
                 <section className="grid grid-cols-2 items-center justify-center w-[100%] h-auto">
                    <div className="cols-span-1 h-auto p-[2rem] flex items-center justify-center">
                        <img className='w-[28rem] h-[30rem] rounded-sm' src={img1}/>
                    </div>
