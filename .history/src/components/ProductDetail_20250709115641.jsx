        ...
        <>
            <div className="w-screen h-auto font-serif">
                <section className="flex flex-row items-center py-2 px-6 justify-between w-[100%] h-auto">
                 ...
                 <section className="grid grid-rows-2 items-center justify-center w-[100%] h-auto gap-6">
                    <div className="w-[20rem] h-[10rem] border-2 border-red-900"></div>
                    <div className="w-[20rem] h-[10rem] border-2 border-blue-900"></div>
                 </section>
            </div>
        </>
    )
