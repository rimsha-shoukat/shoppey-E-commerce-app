...
function ProductDetail(){
    return(
        <>
            <div className="w-screen h-auto font-serif flex flex-col items-center justify-center gap-[1.5rem]">
                <section className="flex flex-row items-center py-2 px-6 justify-between w-[100%] h-auto shadow-md bg-gray-200">
                    <Link to="/">
                 ...
                 <section className="grid grid-cols-2 items-center justify-center w-[60%] h-auto border-2 border-gray-300 rounded-lg">
                    ...
                    <div className="cols-span-1 h-auto bg-gary-200 flex flex-col items-start justify-start p-6"></div>
                 </section>
            </div>
        </>
    )
