            ...
            <div className="w-screen h-auto font-serif flex flex-col items-center justify-center gap-[2rem]">
                <section className="flex flex-row items-center py-2 px-6 justify-between w-[100%] h-auto shadow-sm bg-gray-100">
                 ...
                 <section className="grid grid-cols-2 items-center justify-center w-[60%] h-auto border-2 border-gray-300 rounded-lg gap-[1rem] bg-[#eee2ca]">
                    ...
                    <div className="cols-span-1 h-auto flex flex-col items-start justify-start p-6 font-white">
                        <p className="">New collection</p>
                        <h1 className="text-[1rem]">Textured T-shirt</h1>
                        <p className="mt-4 mb-4">price</p>
                        <p className="text-sm">lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem</p>
                        <div className="flex flex-row item-center justify-center gap-[1rem] border-y-2 border-white p-2">
                            <button className="cursor-pointer">-</button>
                            <h1 className="">0</h1>
                            <button className="cursor-pointer">+</button>
                        </div>
                        <div className="flex flex-row items-center justify-center gap-[1rem]">
                            <button className="w-[1.5rem] h-[1.5rem] rounded-full shadow-md cursor-pointer">XS</button>
                            <button className="w-[1.5rem] h-[1.5rem] rounded-full shadow-md cursor-pointer">S</button>
                            <button className="w-[1.5rem] h-[1.5rem] rounded-full shadow-md cursor-pointer">M</button>
                            <button className="w-[1.5rem] h-[1.5rem] rounded-full shadow-md cursor-pointer">L</button>
                        </div>
                        <div className="flex flex-row items-center justify-center gap-[1rem]">
