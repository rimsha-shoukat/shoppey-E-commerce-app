  ...
  return (
    ...
    <section className="flex flex-row w-[100%] h-auto items-start justify-start gap-4 px-4 py-6">
      ...
      <div className="columns-5 w-[82%] h-auto">
        <img className="w-full rounded-[1rem] mb-4 h-auto border" src={img1} />
        <img className="w-full rounded-[1rem] mb-4 h-auto border" src={img2} />
        <img className="w-full rounded-[1rem] mb-4 h-auto border" src={img3} />
        <img className="w-full rounded-[1rem] mb-4 h-auto border" src={img4} />
        <img className="w-full rounded-[1rem] mb-4 h-auto border" src={img5} />
        <img className="w-full rounded-[1rem] mb-4 h-auto border" src={img6} />
        <img className="w-full rounded-[1rem] mb-4 h-auto border" src={img7} />
        <img className="w-full rounded-[1rem] mb-4 h-auto border" src={img8} />
      </div>
    </section>
