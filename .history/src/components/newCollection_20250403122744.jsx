    ...
    return(
        <>
            <div className="w-[100%] flex flex-col items-center justify-center py-[3rem]">
                <section className="relative w-[50%] max-[1096px]:w-[75%] max-[710px]:w-[55%] max-[560px]:w-[60%]  max-[710px]:gap-[1rem] max-[710px]:flex-col-reverse h-auto flex flex-row items-start justify-center pb-[1rem]">
