           ...
           <div className="relative py-[2rem] w-[100vw] h-[100vh]">
                <nav className="flex flex-row items-center justify-between px-[3rem] w-[100vw] h-auto">
                    ...
                    <div className="flex font-bold font-serif flex-row items-center justify-evenly gap-[2rem]">
                        <button className="cursor-pointer hover:b">New</button>
                        <button className="cursor-pointer hover:b">Men</button>
                        <button className="cursor-pointer hover:b">Women</button>
                        <button className="cursor-pointer hover:b">collection</button>
                        <button className="cursor-pointer hover:b">Trends</button>
                    </div>
