    ...
    return (
        <>
          <section className="relative w-[100%] h-auto">
            {/* background */}
            <img className="absolute w-[100vw] h-[100vw]" src={background} alt="Image"/> 
            {/* content */}
            <div className="relative w-[100%] h-auto flex flex-row items-center justify-between">
                {/* content section */}
                <section className="flex flex-col items-center justify-center p-[2rem] w-[50%] h-auto">
                    ...
                    {/* timer */}
                    <div className="flex flex-row items-center justify-between w-[100%] h-auto">
