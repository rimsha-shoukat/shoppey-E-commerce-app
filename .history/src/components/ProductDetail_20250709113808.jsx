        ...
        <>
            <div className="w-[100%] h-auto font-serif">
                <section className="flex flex-row items-center py-2 px-6 justify-between w-[100%] h-auto">
                 ...
                 <section className="grid grid-cols-2 items-center justify-center w-[100%] h-auto gap-6">
                    <div className="w-[10rem] h-[10rem] border-2 border-red-900"></div>
                    <div className="w-[10rem] h-[10rem] border-2 border-blue-900"></div>
                 </section>
            </div>
        </>
    )
