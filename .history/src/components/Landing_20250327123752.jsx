           ...
           <div className="relative flex flex-col gap-[2rem] py-[2rem] w-[100vw] h-[100vh]">
                ...
                <main className="flex flex-row items-center  justify-center gap-[3rem] w-[100%] h-[98%]">
                    <section className="w-[50%] h-auto flex items-center justify-center">
                        ...
                        <h1 className="text-[clamp(3rem,4vw,5rem)] font-semibold font-serif text-nowrap select-none">Picked Every Item <br/> With Care, You <br/> Must Try</h1>
                    ...
                    <img className="w-[45%] h-[100%] rounded-bl-[10rem]" src={sideImg} alt="side-img" />
                </main>
           </div>
           </div>
        </>
