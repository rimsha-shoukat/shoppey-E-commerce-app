...
const AllProducts = () => {
  return (
    ...
    <section className="flex flex-col w-[100%] h-auto items-center justify-center gap-2 p-6">
      <section className="flex flex-col items-center justify-center bg-red-900 w-[30%] h-auto"></section>
      <section classNAme="grid grid-cols-3 items-center gap-2 justify-center w-[70%] h-auto"></section>
    </section>
