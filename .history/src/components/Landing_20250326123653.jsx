           ...
           <div className="relative flex flex-col gap-[3rem] py-[2rem] w-[100vw] h-[100vh]">
                ...
                <main className="flex flex-row items-center justify-center gap-[5rem] w-[100%] h-[100%]">
                    <section className="w-[50%] h-[100%] flex items-center justify-center">
                        ...
                        <button className="text-[1.2rem] text-nowrap font-bold font-serif cursor-pointer border-2 border-black px-[0.7rem] hover:text-[#b48068] hover:bg-black">see collection <RiArrowRightDoubleFill className="inline text-[1.3rem] hover"/></button>
                        </div>
                    </section>
