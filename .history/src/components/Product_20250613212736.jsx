        ...
        <>
         <div className="w-[100%] h-auto p-[4rem] flex flex-col items-center justify-center font-serif select-none">
            ...
            <section className="flex flex-row items-center justify-center gap-4 leading-4">
                <button className="cursor-pointer hoveborder-b-2">NEW</button>
                <button className="cursor-pointer hoveborder-b-2">WOMEN</button>
                <button className="cursor-pointer hoveborder-b-2">MEN</button>
                <button className="cursor-pointer hoveborder-b-2">TRENDS</button>
