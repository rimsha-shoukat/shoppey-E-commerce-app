...
function Social(){
    return(
        <> 
            ...
            <h1 className="absolute px-[1.6rem] py-[0.6rem] bg-[#eee2ca] border text-[1.1rem] font-semibold border-[#c8967d] bottom-[8rem]">Follow us on social media</h1>
                <div className="flex flex-row items-center justify-evenly w-[100%] h-auto mt-[2.5rem] max-[440px]:text-sm">
