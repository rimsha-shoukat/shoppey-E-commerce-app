  ...
  return (
    ...
    <section className="flex flex-row items-center justify-between p-2 w-[100%] h-auto">
        ...
        <div className="flex flex-row items-center justify-center gap-4 text-lg">
            <FaRegUser className="cursor-pointer      border-n p-2 rounded-full hover:bg-gray-700" />
            <FaCartShopping className="cursor-pointer border-n p-2 rounded-full hover:bg-gray-700" />
        </div>
    </section>
