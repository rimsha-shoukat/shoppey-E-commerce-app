        ...
        <>
             <div className="w-[100%] h-auto font-serif flex flex-col items-center justify-between select-none px-4 max-[400px]:px-2">
                ...
                <section className="columns-5 w-[100%] p-4 max-[400px]:p-2 h-auto max-[900px]:columns-4 max-[660px]:columns-3 max-[500px]:columns-2">
                    <img className="w-full rounded-[1rem] mb-6 max-[400px] h-auto shadow-[0.1px_0.1px_0.1rem_#dd957a]" src={img7} />
                    <img className="w-full rounded-[1rem] mb-6 max-[400px] h-auto shadow-[0.1px_0.1px_0.1rem_#dd957a]" src={img1} />
                    <img className="w-full rounded-[1rem] mb-6 max-[400px] h-auto shadow-[0.1px_0.1px_0.1rem_#dd957a]" src={img2} />
                    <img className="w-full rounded-[1rem] mb-6 max-[400px] h-auto shadow-[0.1px_0.1px_0.1rem_#dd957a]" src={img3} />
                    <img className="w-full rounded-[1rem] mb-6 max-[400px] h-auto shadow-[0.1px_0.1px_0.1rem_#dd957a]" src={img4} />
                    <img className="w-full rounded-[1rem] mb-6 max-[400px] h-auto shadow-[0.1px_0.1px_0.1rem_#dd957a]" src={img5} />
                    <img className="w-full rounded-[1rem] mb-6 max-[400px] h-auto shadow-[0.1px_0.1px_0.1rem_#dd957a]" src={img6} />
                    <img className="w-full rounded-[1rem] mb-6 max-[400px] h-auto shadow-[0.1px_0.1px_0.1rem_#dd957a]" src={img8} />
                    <img className="w-full rounded-[1rem] mb-6 max-[400px] h-auto shadow-[0.1px_0.1px_0.1rem_#dd957a]" src={img9} />
                    <img className="w-full rounded-[1rem] mb-6 max-[400px] h-auto shadow-[0.1px_0.1px_0.1rem_#dd957a]" src={img3} />
                    <img className="w-full rounded-[1rem] mb-6 max-[400px] h-auto shadow-[0.1px_0.1px_0.1rem_#dd957a]" src={img4} />
                </section>
