        ...
        <>
            <div className="w-[100%] flex flex-col items-center justify-center py-[3rem]">
                <section className="relative w-[50%] h-auto flex flex-row items-start justify-center pb-[1rem]">
                    ...
                    <section className="absolute bottom-0 right-0 bg-gray-200 p-[0.5rem] w-auto flex flex-row gap-[2rem] select-none">
                        <div className="border-r-2 border-r-gray-600 w-[30%] text-center">
                            <h1 className="text-[2rem] font-bold">2025</h1>
                            <p className="text-semibold leading-[0.5]">Year</p>
                        </div>
                        <div className="border-r-2 border-r-gray-600 w-[30%] text-center px-[0.5rem]">
                            <h1 className="text-[2rem] font-bold">8900+</h1>
                            <p className="text-semibold leading-[0.5]">Products</p>
                        </div>
                        <div className="w-[30%] text-center px-[0.5rem]">
