...
function BestSeller(){
  ...
  const handleClick = (index) => {
    ...
    return (
        <>
           <section className="flex flex-row max-[750px]:flex-col items-center justify-center gap-[3rem] w-[100%] h-auto py-[4rem] bg-[#251201]">
                <article className="container flex flex-col items-start justify-start gap-[2rem] max-[860px]:pl-[0.65rem] pl-[3rem] w-[32%] max-[750px]:w-[50%] max-[440px]:w-[80%] text-white">
                    <h1 className="text-6xl max-[1016px]:text-5xl max-[750px]:text-6xl max-[510px]:text-5xl font-bold select-none">Best Seller Item</h1>
                ...
                <section className="max-[1185px]:justify-center flex flex-row items-start justify-start mt-[2">
