    ...
    return(
        <> 
            <section className="flex flex-col items-center justify-center w-[100%] h-auto font-serif p-6 relative select-none">
                ...
                <h1 className="absolute px-[2rem] py-[1rem] bg-[#eee2ca] border text-[1.2rem] font-semibold border-[#c8967d] -bottom-2">Follow us on social media</h1>
            </section>
            <h1 className="w-[100%] flex items-center justify-center text-[1.2rem] mt-[2rem]">copyright@rkCodex</h1>
        </>
    )
}
