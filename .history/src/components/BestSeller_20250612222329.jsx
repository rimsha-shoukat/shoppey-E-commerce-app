...
function BestSeller(){
  ...
  const handleClick = (index) => {
    ...
    return (
        <>
           <section className="flex flex-row max-[860px]:flex-col items-center justify-center gap-[1.5rem] w-[100%] h-auto py-[5rem] bg-[#251201]">
                <article className="container flex flex-col items-start justify-start gap-[1.5rem] max-[860px]:pl-[0.65rem] pl-[2rem] w-[35%] max-[1250px]:w-[40%] max-[860px]:w-[80%] text-white">
                    <h1 className="text-[clamp(2.5rem,4.5vw,5rem)] font-bold select-none leading-16">Best Seller Item</h1>
