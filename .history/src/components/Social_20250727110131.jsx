        ...
        <> 
            <section className="flex flex-col items-center justify-center w-[100%] my-[1rem] h-auto font-serif relative select-none overflow-hidden">
                <div className="flex flex-row items-center justify-center gap-0 flex-wrap">
                    <img className="w-[15.5rem] h-[12rem]" src={i1} alt="youtube" />
                    <img className="w-[15.5rem] h-[12rem]" src={i3} alt="pinterest" />
                    <img className="w-[15.5rem] h-[12rem]" src={i4} alt="facebook" />
                    <img className="w-[15.5rem] h-[12rem]" src={i2} alt="telegram" />
                    <img className="w-[15.5rem] h-[12rem]" src={i5} alt="google" />
                </div>
