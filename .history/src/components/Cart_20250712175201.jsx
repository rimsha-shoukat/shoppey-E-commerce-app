                ...
                <section className="w-[100%] h-auto flex flex-col items-center justify-center">
                    ...
                    <div className="w-[100%] flex flex-row items-center justify-between py-6 border-t-2 border-t-gray-400">
                        <div className="flex flex-col items-center justify-start gap-2">
                            ...
                            <FaArrowRight className="w-[2rem] h-[2rem6] text-black cursor-pointer bg-gray-500 rounded-full" />
                            </div>
                        </div>
                        <h1 className="">Delivery charges: <span className="font-bold">$10</span></h1>
                    </div>
                </section>
            </div>
        </>
