...
function SignIU() {
    ...
    return (
        <>
            <main className="relative flex flex-row-reverse max-[800px]:flex-col items-center justify-center w-screen h-au max-[800px]:h-auto select-none font-serif overflow-hidden">
                {
