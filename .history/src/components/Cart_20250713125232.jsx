    ...
    return(
        <>
            <div className="w-[100%] h-auto font-serif flex flex-col items-center justify-between select-none">
                ...
                <section className="w-[100%] h-auto flex flex-col items-center justify-center px-6">
                    <div className="w-[100%] flex flex-row items-center justify-between py-6 gap-4 border-t-2 border-t-gray-400">
                        ...
                        <div className="flex flex-row items-center justify-center gap-[6rem] max-[600px]:gap-[3rem]">
