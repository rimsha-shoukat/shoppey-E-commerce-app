    ...
    return(
        <>
            <section className="flex flex-col items-center max-[440px]:p-[1rem] justify-between gap-2 p-[3rem] font-serif">
                ...
                <div className="flex flex-row pt-[1.rem] gap-4 items-center justify-between cursor-grab select-none scroll-smooth overflow-x-scroll overflow-y-hidden"
                style = {{
                    scrollbarWidth: 'none',
                    msOverflowStyle: 'none',
                }}>
                    {Users.map((user,i) => (
                        <div className="flex flex-col items-center justify-between bg-[#eee2ca] p-4 rounded-md border-2 border-[#c8967d]">
