...
const AllProducts = () => {
  return (
    ...
    <section className="flex flex-row w-[100%] h-auto items-center justify-center gap-2 p-6">
      <section className="flex flex-col items-center justify-center w-[30%] h-auto rounded-md ring-2 ring-[#b48068] px-2">
        <button className="font-extrabold font-serif text-xl cursor-pointer hover:text-gray-500">shoppey</button>
        <button className="font-extrabold font-serif text-xl cursor-pointer hover:text-gray-500">shoppey</button>
        <button className="font-extrabold font-serif text-xl cursor-pointer hover:text-gray-500">shoppey</button>
        <button className="font-extrabold font-serif text-xl cursor-pointer hover:text-gray-500">shoppey</button>
      ...
      <section classNAme="grid grid-rows-3 items-center gap-2 justify-center w-[70%] h-auto">
