...
function SignIU(){
    return(
        <>
        <main className="flex flex-row-reverse items-center justify-center w-[100%] h-[100vh] select-none -gap-4">
            <section className="relative w-[28rem] h-[32rem] rounded-xl border-0 shadow-lg font-serif z-2">
            ...
            <section className="w-[25rem] h-[30rem] bg-[#251201] rounded-xl border-0 shadow-lg font-serif flex flex-col items-center justify-center gap-2 z-4">
                <h1 className="font-bold text-[2.3rem]">Welcome Back!</h1>
                <p className="font-semibold text-center">Enter personal details to your account</p>
