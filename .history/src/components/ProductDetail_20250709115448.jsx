...
function ProductDetail(){
    return(
        <>
            <div className="w-screens h-auto font-serif">
                <section className="flex flex-row items-center py-2 px-6 justify-between w-[100%] h-auto">
                 ...
                 <section className="grid grid-cols items-center justify-center w-[100%] h-auto gap-6">
                    <div className="cols-span-1 h-[10rem] border-2 border-red-900"></div>
                    <div className="cols-span-1 h-[10rem] border-2 border-blue-900"></div>
                 </section>
            </div>
        </>
    )
