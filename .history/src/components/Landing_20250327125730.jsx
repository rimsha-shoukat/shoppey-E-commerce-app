           ...
           <div className="relative flex flex-col gap-[2rem] py-[2rem] w-[100vw] h-[100vh]">
                ...
                <main className="flex flex-row max-[978px]:flex-col items-center justify-between w-[100%] h-[98%]">
                    <section className="w-[50%] max-[978px]:w-[100%] h-auto max-[978px]:h-[50%] flex items-center justify-center">
                        ...
                        <h1 className="text-[clamp(3rem,3.5vw,5rem)] max-[978px]:flex-co font-semibold font-serif text-nowrap select-none">Picked Every Item <br/> With Care, You <br/> Must Try</h1>
