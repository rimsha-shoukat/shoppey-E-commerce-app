        ...
        <>
           <section className="flex flex-row max-[750px]:flex-col items-center justify-center gap-[1rem] w-[100%] h-auto py-[4rem] bg-[#251201]">
                <article className="container flex flex-col items-start justify-start gap-[2rem] max-[860px]:pl-[0.65rem] pl-[3rem] w-[40%] max-[750px]:w-[50%] max-[440px]:w-[80%] text-white">
                    ...
                    <button className="hover:bg-white drop-shadow-lg hoover:transition-all duration-700 delay-150 ease-in-out hover:text-[#251201] b px-[0.8rem] pt-[0.4rem] leading-0 font-bold rounded-sm cursor-pointer">SEE MORE</button>
                </article>
