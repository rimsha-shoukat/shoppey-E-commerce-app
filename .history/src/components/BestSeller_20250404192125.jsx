        ...
        <>
           <section className="flex flex-row items-center justify-center gap-[0.5rem] w-[100%] h-auto py-[2rem] bg-[#251201]">
                <article className="container pl-[2rem] w-[30%] text-white">
                    ...
                    <p className="select-none text-">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Modi, quia esse saepe sunt facilis neque iusto porro rem consequuntur, ab minima iste nemo quidem temporibus iure excepturi ipsam perferendis sequi.</p>
