        ...
        <>
             <div className="w-[100%] h-auto font-serif flex flex-col items-center justify-between select-none px-4 max-[350px]:px-2">
                ...
                <section className="w-[100%] h-auto flex flex-col items-center justify-center">
                    <div className="w-auto flex flex-row items-start justify-start py-6 max-[350px]:py-2 gap-4 max-[350px]:gap-2 border-t-2 border-t-gray-400">
                        <img className="w-[10rem] h-[10rem] rounded-sm" src={img1} />
                        <div className="flex flex-row items-center justify-between ga">
                ...
                <h1 className="text-[2rem] font-bold ">You may like</h1>
