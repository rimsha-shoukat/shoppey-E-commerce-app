...
function SignIU(){
    return(
        ...
        <main className="relative flex flex-row-reverse items-center justify-center w-[100%] h-[100vh] select-none font-serif">
            ...
            <section className="absolute -left-[10.5rem] w-[24rem] h-[28rem] text-[#251201] bg-[#eee2ca] rounded-xl border-0 shadow-xl/30 flex flex-col items-center justify-center gap-2 z-4">
