           ...
           <div className="relative flex flex-col gap-[2rem] pt-[1rem] max-[710px]:pt-[0rem] w-[100vw] h-[100vh]">
                <nav className="flex  flex-row items-center justify-between pt-[1rem] px-[3rem] w-[100vw] h-[6%]">
                        ...
                        <div className="flex max-[710px]:flex-col max-[710px]:right-[3rem] max-[710px]:p-[2rem] max-[710px]:absolute max-[710px]:bg-[#ac7e60] font-bold font-serif flex-row items-center justify-evenly gap-[2rem]">
                            <button className="cursor-pointer max-[710px]:hover:bg-black max-[710px]:hover:text-[#b48068] max-[170px]:hover:border-none max-[710px]:w-[100%] max-[710px]:py-[] hover:border-b-2 border-b-black">New</button>
                            <button className="cursor-pointer max-[710px]:hover:bg-black max-[710px]:hover:text-[#b48068] max-[170px]:hover:border-none max-[710px]:w-[100%] max-[710px]:py-[] hover:border-b-2 border-b-black">Men</button>
                            <button className="cursor-pointer max-[710px]:hover:bg-black max-[710px]:hover:text-[#b48068] max-[170px]:hover:border-none max-[710px]:w-[100%] max-[710px]:py-[] hover:border-b-2 border-b-black">Women</button>
                            <button className="cursor-pointer max-[710px]:hover:bg-black max-[710px]:hover:text-[#b48068] max-[170px]:hover:border-none max-[710px]:w-[100%] max-[710px]:py-[] hover:border-b-2 border-b-black">Collection</button>
                            <button className="cursor-pointer max-[710px]:hover:bg-black max-[710px]:hover:text-[#b48068] max-[170px]:hover:border-none max-[710px]:w-[100%] max-[710px]:py-[] hover:border-b-2 border-b-black">Trends</button>
