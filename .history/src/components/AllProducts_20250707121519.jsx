        ...
        <section className="flex flex-col items-center font-serif p-4 justify-center w-[100%] border-none rounded-[2rem] h-auto bg-linear-to-l from-[#dd957a] to-[#eee2ca]">
           <h1 className="font-bold text-xl">Explore All Products</h1>
            <div className="flex flex-row items-center justify-center w-[90%]">
                <input type="text" placeholder="Search" className="w-[2] h-[2.5rem] px-2 rounded-full border-none bg-white/50 text-black placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-[#b48068]" />
                <CiSearch />
            </div>
        </section>
