...
function Social(){
    return(
        <> 
            <section className="flex flex-col items-center justify-center w-[100%] h-auto font-serif mt-6 relative select-none border border-[#c8967d] mx-">
                <div className="flex flex-row items-center justify-center gap-0">
                    <img className="w-[15.5rem] h-[14rem]" src={img1} alt="" />
                    <img className="w-[15.5rem] h-[14rem]" src={img2} alt="" />
                    <img className="w-[15.5rem] h-[14rem]" src={img3} alt="" />
                    <img className="w-[15.5rem] h-[14rem]" src={img4} alt="" />
                    <img className="w-[15.5rem] h-[14rem]" src={img5} alt="" />
                </div>
