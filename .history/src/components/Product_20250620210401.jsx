...
const Slider = () => {
  ...
  const [scrollLeft, serScrollLeft] = useState(0);
  ...
  const handleMouseMove = (e) => {
    ...
    sliderRef.current.scroll = scrollLeft - walk;
  };
  ...
  return (
      <div ref={sliderRef} className="flex flex-row gap-2 items-center justify-between cursor-grab select-none scroll-smooth overflow-x-scroll overflow-y-hidden"
      style = {{
        scrollbarWidth: 'none',
        msOverflowStyle: 'none',
      }}
      onMouseDown={handleMouseDown} onMouseMove={handleMouseMove} onMouseUp={handleMouseUp} onMouseLeave={handleMouseLeave} onTouchStart={handleTouchStart} onTouchMove={handleTouchMove} onTouchEnd={handleToucEnd}
      >
        {[...Items(10).map((_,i) => (
          <div key={i} className="flex flex-col flex-shrink- w-auto h-auto shadow-lg">
