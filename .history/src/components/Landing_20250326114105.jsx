           ...
           <div className="relative py-[2rem] w-[100vw] h-[100vh]">
                <nav className="flex flex-row items-center justify-between px-[3rem] w-[100vw] h-auto">
                    ...
                    <div className="flex font-bold font-serif flex-row items-center justify-evenly gap-[2rem]">
                        <button className="cursor-pointer hover:border-b border-">New</button>
                        <button className="cursor-pointer hover:border-b border-">Men</button>
                        <button className="cursor-pointer hover:border-b border-">Women</button>
                        <button className="cursor-pointer hover:border-b border-">collection</button>
                        <button className="cursor-pointer hover:border-b border-">Trends</button>
                    </div>
