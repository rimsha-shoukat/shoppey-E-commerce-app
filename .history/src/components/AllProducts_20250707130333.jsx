    ...
    <section className="flex flex-col items-center justify-center w-[100%] p-4 h-auto bg-linear-to-l from-[#dd957a] to-[#eee2ca] gap-2">
           <h1 className="font-bold text-2xl">Explore All Products</h1>
            <div className="flex flex-row items-center justify-center w-[100%]">
                <input type="text" placeholder="Search" className="w-[50%] h-[2.5rem] px-4 rounded-full  border-none bg-white/50 text-black placeholder:text-gray-700 focus:outline-none focus:ring-2 focus:ring-[#b48068]" ></o
