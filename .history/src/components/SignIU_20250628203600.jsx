...
function SignIU(){
    ...
    return(
        ...
        <main className="relative flex flex-row-reverse items-center justify-center w-[100%] h-[100vh] select-none font-serif">
            ...
            <section className="absolute -left-[10.5rem] max-[800px]:-left-[9rem] max-[800px]:w-[20rem] max-[800px]:h-[2rem] w-[24rem] h-[28rem] bg-[#eee2ca] rounded-xl border-0 shadow-xl  z-4">
