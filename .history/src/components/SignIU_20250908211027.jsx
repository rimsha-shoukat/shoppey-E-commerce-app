...
function SignIU() {
    ...
    return (
        <>
            <main className="relative flex flex-row-reverse max-[800px]:flex-col items-center justify-center w-screen h-[100vj] max-[800px]:h-auto select-none font-serif overflow-hidden">
                {
                ...
                <section className="relative left-[10.5rem] max-[800px]:left-0 max-[800px]:-bottom-[22rem] max-[440px]:w-[100%] w-[26rem] h-[30rem] rounded-xl border-0 shadow-xl z-2">
                ...
                <section className="absolute -left-[10.5rem] max-[800px]:left-[2rem] max-[800px]:bottom-[4rem] max-[440px]:left-0 max-[440px]:w-[100%] w-[22rem] h-[26rem] bg-[#eee2ca] rounded-xl border-0 shadow-xl  z-4">
