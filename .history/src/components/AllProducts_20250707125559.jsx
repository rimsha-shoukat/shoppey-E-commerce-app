...
const AllProducts = () => {
  return (
    ...
    <section className="flex flex-col items-center justify-center w-[100%] p-4 h-auto bg-linear-to-l from-[#dd957a] to-[#eee2ca] gap-2">
           <h1 className="font-bold text-2x">Explore All Products</h1>
