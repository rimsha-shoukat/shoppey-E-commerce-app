    ...
    return(
        <>
           <div className="relative w-[100%] h-screen">
            {/* Background Image */}
           <img className="absolute w-[100%] h-[100vh]" src="assets/landing-bg.jpg" alt="landing Image"/> 
           {/* Content */}
           <div className="relative flex flex-col gap-[2rem] pt-[1rem] max-[710px]:pt-[0rem] w-[100%] h-[100vh]">
                ...
                <main className="flex flex-row max-[710px]:flex-col max-[710px]:gap-[1rem] overflow-hidden items-center justify-between w-[100%] h-[94%]">
                    ...
                    <img className="w-[50%] h-[100%] max-[710px]:w-[70%] max-[560px]:w-[90%] max-[360px]:w-[100%] px-[2rem] rounded-bl-[10rem] overflow-hidden" src="assets/landing-side-img.jpg" alt="side-img" />
                </main>
           </div>
           </div>
        </>
