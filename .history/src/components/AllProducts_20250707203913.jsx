...
const AllProducts = () => {
  return (
    ...
    <section className="flex flex-col items-center justify-center w- p-6 h-auto bg-linear-to-l from-[#dd957a] to-[#eee2ca] gap-2">
    ...
    <section className="flex flex-row w-[100%] h-auto items-start justify-start gap-2">
      ...
      <section className="[column-width:150px] w-[75%] h-auto">
