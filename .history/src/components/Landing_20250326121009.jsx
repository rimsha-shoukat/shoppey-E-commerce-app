    ...
    return(
        <>
           ...
           <div className="relative flex flex-col gap-[3rem] py-[2rem] w-[100vw] h-[100vh]">
                ...
                <main className="flex flex-row items-center justify-center gap-[5rem] w-[100%] h-[100%] border-2 border-red-900">
                    <section className="w-[50%] h-[100%] flex items-center justify-center border-2 border-black">
                        <div className="w-auto h-auto border-2 border-gray-900">
                        <h1 className="text-[3.5rem] font-semibold text-nowrap">Picked Every Item <br/> With Care, You <br/> Must Try</h1>
                        <button className="text-[1.5rem]">see collection --</button>
                        </div>
                    </section>
