        ...
        <>
          <section className="relative w-[100%] h-auto">
            ...
            <div className="relative w-[100%] h-auto flex flex-row items-center justify-between text-[#251201]">
                {/* content section */}
                <section className="flex flex-col items-start justify-center gap-2 pl-[6rem] py-[6rem] w-[50%] h-auto select-none font-serif">
                    ...
                    <div className="flex flex-row items-start justify-between gap-10 h-auto mt-6">
                        <span className="w-[4.6rem] h-[4.5rem] bg-[#eee2ca] flex flex-col items-center justify-center gap-[1.2rem]">
                            <h1 className="text-[2.3rem] font-bold leading-4">08</h1>
                            <p className="font-semibold leading-0">Hours</p>
                        </span>
                        <span className="w-[4.6rem] h-[4.6rem] bg-[#eee2ca] flex flex-col items-center justify-center gap-[1.2rem]">
