          ...
          <section className="relative w-[100%] h-[100vh]">
            ...
            <div className="relative w-[100%] h-[100%] flex flex-row items-center justify-between text-[#251201]">
                ...
                <section className="flex flex-col items-start justify-center gap-4 pl-[4rem] pb-[6rem] pt-[4rem] w-[50%] h-auto select-none font-serif">
                    ...
                    <button className="mt-[2rem] hover:transition-all duration-700 ease-in-out cursor-pointer px-6 max-[900px]:px-4 py-2 max-[900px]:py-[0.35re]  bg-[#251201] text-[#eee2ca] font-bold text-[1.2rem] max-[900px]:text-[1rem] hover:bg-[#eee2ca] hover:text-[#251201]">SHOP NOW</button>
                </section>
                {/* image section */}
