...
function SignIU(){
    return(
        ...
        <main className="relative flex flex-row-reverse items-center justify-center w-[100%] h-[100vh] select-none font-serif">
            ...
            <section className="absolute -left-[1rem] w-[25rem] h-[30rem] text-[#251201] bg-[#eee2ca] rounded-xl border-0 shadow-xl flex flex-col items-center justify-center gap-2 z-4">
                <h1 className="font-bold text-[2.3rem]">Welcome Back!</h1>
                <p className="font-semibold text-center">Enter personal details to your account</p>
