                ...
                <section className="w-[100%] h-auto flex flex-col items-center justify-center">
                    <div className="w-[100%] flex flex-row items-center justify-between py-6 border-t-2 border-t-gray-400">
                        ...
                        <div className="flex flex-row items-center justify-evenly w-[50%]">
                            ...
                            <button className="px-4 py-[10px] rounded-md text-nowrap shadow-[0.5px_0.5px_2px] hover:shadow-[0.5px_0.5px_3px] hover:shadow-gray-800 hover:bg-red-400 hover:text-white cursor-pointer">Remove</button>
                        </div>
                    </div>
                </section>
            </div>
