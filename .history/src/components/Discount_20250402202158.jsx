...
function Discount(){
    return(
        ...
        <div className="w-[100%] h-auto py-[5rem] flex flex-row max-[710px]:flex-col max-[710px]:gap-[1rem] items-center justify-evenly">
            ...
            <section className='w-[25%] max-[890px]:w-[30%] h-auto bg-pink-500 p-[1rem] max-[710px]:w-[50%]'>
            ...
            <section className='w-[25%] max-[890px]:w-[30%] h-auto bg-yellow-300 p-[1rem] max-[710px]:w-[50%] max-[460px]:w-[5=70%]'>
