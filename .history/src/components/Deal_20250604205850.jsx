        ...
        <>
          <section className="relative w-[100%] h-auto">
            ...
            <div className="relative w-[100%] h-[100%] flex flex-row items-center justify-between text-[#251201]">
                {/* content section */}
                <section className="flex flex-col items-start justify-center gap-4 pl-[4rem] py-[6.5rem] w-[50%] h-auto select-none font-serif">
                ...
                {/* image section */}
                <section className="w-[50%] px-[4rem] pt-[4rem]">
                    {/* img */}
