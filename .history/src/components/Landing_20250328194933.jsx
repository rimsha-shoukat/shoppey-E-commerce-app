    ...
    return(
        <>
           ...
           <div className="relative flex flex-col gap-[2rem] pt-[2rem] w-[100vw] h-[100vh]">
                <nav className="flex  flex-row items-center justify-between pt-[1rem] max-[710px]:mt-[0rem] px-[3rem] w-[100vw] h-[6%]">
                    ...
                    <TbLayoutNavbarExpand className="hidden max-[710px]:block"/>
                </nav>
