...
function Landing(){
    return(
        <>
           ...
           {/* Content */}
           <div className="relative flex flex-col gap-[] py-[2rem] w-[100vw] h-[100vh]">
                ...
                <main className="flex flex-row items-center justify-center gap-[3rem] w-[100%] h-auto border-2 border-red-900">
                    <section className="w-[50%] h-auto flex flex-col items-center justify-center gap-[1rem] border-2 border-black"></section>
                    <img src="" alt="side-img" />
                </main>
           </div>
           </div>
        </>
