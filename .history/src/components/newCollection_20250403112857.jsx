        ...
        <>
            <div className="w-[100%] flex flex-col items-center justify-center py-[3rem]">
                <section className="relative w-[50%] h-auto flex flex-row items-start justify-center pb-[1rem]">
                    ...
                    <section className="absolute bottom-0 right-0 bg-gray-200 py-[0.5rem] w-auto flex flex-row">
                        <div className="border-r-2 border-r-gray-600 px-[1.8rem] text-center line-height-0">
                            <h1 className="text-[2rem] font-bold">2025</h1>
                            <p>Year</p>
                        </div>
                        <div className="border-r-2 border-r-gray-600 px-[1.8rem] text-center">
                            <h1 className="text-[2rem] font-bold">8900+</h1>
                            <p>Products</p>
                        </div>
                        <div className="px-[1.8rem] text-center">
