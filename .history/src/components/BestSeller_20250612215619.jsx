...
function BestSeller(){
  ...
  const handleClick = (index) => {
    ...
    return (
        <>
           <section className="flex flex-row max-[8600px]:flex-col items-center justify-center gap-[3rem] w-[100%] h-auto py-[5rem] bg-[#251201]">
                <article className="container flex flex-col items-start justify-start gap-[2rem] max-[860px]:pl-[0.65rem] pl-[3rem] w-[32%] max-[750px]:w-[50%] max-[440px]:w-[80%] text-white">
                    <h1 className="text-[clamp(2rem,5vw,5rem)] font-bold select-none">Best Seller Item</h1>
