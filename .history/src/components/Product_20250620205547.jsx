...
const Slider = () => {
  ...
  return (
      <div ref={sliderRef} className="flex flex-row gap-2 items-center justify-between cursor-grab select-none scroll-smooth overfloe-x-scroll overfloe-y-hidden">
