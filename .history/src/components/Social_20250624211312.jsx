...
function Social(){
    return(
        <> 
            ...
            <h1 className="absolute px-[1.8rem] py-[0.7rem] bg-[#eee2ca] border text-[1.15rem] font-semibold border-[#c8967d] bottom-[7rem]">Follow us on social media</h1>
                <div className="flex flex-row items-center justify-evenly w-[100%] h-auto mt-[3rem] max-[440px]:text-sm">
