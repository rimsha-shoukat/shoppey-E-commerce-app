                ...
                <section className="flex flex-row items-center py-2 px-6 justify-between w-[100%] h-auto shadow-sm bg-gray-100">
                 ...
                 <section className="grid grid-cols-2 select-none items-center justify-center w-[60%] h-auto border-2 border-gray-300 rounded-lg gap-[1rem] bg-[#eee2ca]">
                    ...
                    <div className="cols-span-1 h-auto flex flex-col items-start justify-start p-6">
                        ...
                        <div className="flex flex-row item-center justify-center gap-[1rem] text-[1.2rem] border-y-2 border-white p-2 mb-8 leading-4">
                            <button className="cursor-pointer">-</button>
                            <h1 className="">0</h1>
                            <button className="cursor-pointer">+</button>
                        </div>
                        <div className="flex flex-row items-center justify-center gap-[1rem] mb-10">
                            <button className="w-[2.5rem] h-[2.5rem] rounded-full shadow-[0.5px_0.5px_0.5px] cursor-pointer">XS</button>
                            <button className="w-[2.5rem] h-[2.5rem] rounded-full shadow-[0.5px_0.5px_0.5px] cursor-pointer">S</button>
                            <button className="w-[2.5rem] h-[2.5rem] rounded-full shadow-[0.5px_0.5px_0.5px] cursor-pointer">M</button>
                            <button className="w-[2.5rem] h-[2.5rem] rounded-full shadow-[0.5px_0.5px_0.5px] cursor-pointer">L</button>
                        </div>
                        <div className="flex flex-row items-center justify-center gap-[1rem]">
                        <button className="h-[2.5rem] w-[8rem] rounded-md shadow-md cursor-pointer">Add to cart</button>
                        <button className="h-[2.5rem] w-[2.5rem] rounded-md shadow-md cursor-pointer">Save</button>
                        </div>
                    </div>
                 </section>
            </div>
