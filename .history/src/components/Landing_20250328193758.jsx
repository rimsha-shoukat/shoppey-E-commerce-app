...
function Landing(){
    return(
        <>
           ...
           {/* Content */}
           <div className="relative flex flex-col gap-[2rem] pt-[2rem] w-[100vw] h-[100vh]">
                <nav className="flex max-[710px]:hidden flex-row items-center justify-between pt-[1rem] px-[3rem] w-[100vw] h-[6%]">
                ...
                <main className="flex flex-row max-[710px]:flex-col max-[710px]:gap-[1rem] overflow-hidden items-center justify-between w-[100%] h-[94%]">
                    <section className="w-[50%] h-[100%] max-[710px]:h-auto flex items-center justify-center">
                        ...
                        <h1 className="text-[clamp(1.8rem,3.5vw,5rem)] font-semibold font-serif text-nowrap select-none">Picked Every Item <br/> With Care, You <br/> Must Try</h1>
                    ...
                    <img className="w-[50%] h-[100%] max-[710px]:w-[70%] max-[560px]:w-[90%] max-[360px]:w-[1] px-[2rem] rounded-bl-[10rem] overflow-hidden" src={sideImg} alt="side-img" />
                </main>
           </div>
           </div>
        </>
