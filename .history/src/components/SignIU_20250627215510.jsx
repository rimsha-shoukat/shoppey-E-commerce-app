...
function SignIU(){
    return(
        ...
        <main className="relative flex flex-row-reverse items-center justify-center w-[100%] h-[100vh] select-none font-serif">
            <section className="relative left-[11rem] w-[27rem] h-[32rem] rounded-xl border-0 shadow-lg z-2">
            ...
            <section className="absolute -left-[11rem] w-[24rem] h-[28rem] text-[#251201] bg-[#eee2ca] rounded-xl border-0 shadow-xl flex flex-col items-center justify-center gap-2 z-4">
