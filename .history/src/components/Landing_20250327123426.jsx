           ...
           <div className="relative flex flex-col gap-[2rem] py-[2rem] w-[100vw] h-[100vh]">
                ...
                <main className="flex flex-row items-center  justify-center w-[100%] h-[98%]">
                    <section className="w-[50%] h-auto flex items-center justify-center">
                        ...
                        <button className="text-[1.2rem] text-nowrap font-bold font-serif cursor-pointer border-2 border-black px-[0.5rem] text-[#b48068] hover:thover:bg-black">see collection <RiArrowRightDoubleFill className="inline text-[1.6rem]"/></button>
                        </div>
                    </section>
