                 ...
                 <section className="grid grid-cols-2 max-[600px]:grid-cols-1 select-none items-center justify-center max-[600px]:w-[60%] max-[500px]:w-[70%] max-[400px]:w-[90%] w-[60%] max-[1140px]:w-[70%] max-[970px]:w-[80%] max-[800px]:w-[90%] h-auto border-2 border-gray-300 rounded-lg gap-[1rem] bg-[#f7ecd6]">
                    ...
                    <div className="cols-span-1 h-auto flex flex-col items-start justify-start p-6">
                        ...
                        <div className="flex flex-row items-center justify-center gap-[1rem] mb-6">
                            <input className="w-[2.5rem] h-[2.5rem] hover:bg-gray-500 hover:shadow-[0.5px_0.5px_3px] hover:shadow-gray-800 hover:text-white rounded-full shadow-[0.5px_0.5px_2px] cursor-pointer">XS</button>
                            <input className="w-[2.5rem] h-[2.5rem] hover:bg-gray-500 hover:shadow-[0.5px_0.5px_3px] hover:shadow-gray-800 hover:text-white rounded-full shadow-[0.5px_0.5px_2px] cursor-pointer">S</button>
                            <input className="w-[2.5rem] h-[2.5rem] hover:bg-gray-500 hover:shadow-[0.5px_0.5px_3px] hover:shadow-gray-800 hover:text-white rounded-full shadow-[0.5px_0.5px_2px] cursor-pointer">M</button>
                            <input className="w-[2.5rem] h-[2.5rem] hover:bg-gray-500 hover:shadow-[0.5px_0.5px_3px] hover:shadow-gray-800 hover:text-white rounded-full shadow-[0.5px_0.5px_2px] cursor-pointer">L</button>
                        </div>
