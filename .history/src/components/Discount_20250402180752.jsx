    ...
    return(
        ...
        <div className="w-[100%] h-auto p-[5rem] flex flex-row items-center justify-evenly">
            <section className='w-[25%] h-auto bg-gray-300 p-[1rem]'>
                ...
                <button className='group font-semibold hover:bg-gray-200 rounded-md pr-[0.5rem] py-[0.3rem] cursor-pointer'>Go To Collection <FaArrowRightLong className='inline group-hover:translate-x-2'/></button>
                </div>
            </section>
