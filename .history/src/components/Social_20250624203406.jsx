    ...
    return(
        <> 
            <section className="flex flex-col items-center justify-center w-[100%] h-auto font-serif p-6 relative select-none">
                ...
                <h1 className="absolute px-[2rem] py-[1rem] bg-[#eee2ca] border text-[1.2rem] font-semibold border-[#c8967d]">Follow us on social media</h1>
                <div className="flex flex-row items-center justify-evenly w-[100%] h-auto mt-[2.5rem]">
