    ...
    return(
        ...
        <div className="w-[100%] h-auto p-[5rem] flex flex-row items-center justify-evenly">
            <section className='w-[25%] h-auto bg-gray-300 p-[1rem]'>
                <img className="h-[10rem] hover:scale-105 hover:rotate-x-15 hover:-rotate-y-15 transition-all ease-in-out duration-300 delay-150" src={Men} alt="Men discount" />  
            ...
            <section className='w-[25%] h-auto bg-pink-500 p-[1rem] '>
                ...
                <img src={Women} alt="Women Discount" />
            </section>
