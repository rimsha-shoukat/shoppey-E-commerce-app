...
const AllProducts = () => {
  return (
    ...
    <section className="flex flex-row items-center justify-between p-4 w-[100%] h-auto">
        <Link to="/">
    ...
    <section className="flex flex-col items-center p-4 justify-center w-[100%] border-none rounded-[1rem] h-auto bg-linear-to-l from-[#dd957a] to-[#eee2ca] gap">
