    ...
    return(
        <>
         <div className="w-[100%] h-auto p-[4rem] max-[430px]:p-[1rem] flex flex-col items-center justify-center font-serif select-none">
            ...
            {/* Product slider */}
            <section className="grid grid-rows-2 gap-2 mt-6 border-2 border-red-900 overflow-hidden">
                <div className="flex flex-row gap-2 bg-red-900 p-2">
                    <img className="w-[18rem] h-[16rem]" src={demo} alt="demo" />
                    <img className="w-[18rem] h-[16rem]" src={demo} alt="demo" />
                    <img className="w-[18rem] h-[16rem]" src={demo} alt="demo" />
                    <img className="w-[18rem] h-[16rem]" src={demo} alt="demo" />
                    <img className="w-[18rem] h-[16rem]" src={demo} alt="demo" />
                ...
                <div className="flex flex-row gap-2 bg-blue-900 p-2">
                    <img className="w-[20rem] h-[16rem]" src={demo} alt="demo" />
                    <img className="w-[20rem] h-[16rem]" src={demo} alt="demo" />
                    <img className="w-[20rem] h-[16rem]" src={demo} alt="demo" />
                    <img className="w-[20rem] h-[16rem]" src={demo} alt="demo" />
                    <img className="w-[20rem] h-[16rem]" src={demo} alt="demo" />
