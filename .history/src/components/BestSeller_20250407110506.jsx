        ...
        <>
           <section className="flex flex-row items-center justify-center gap-[2rem] w-[100%] h-auto py-[4rem] bg-[#251201]">
                ...
                <section className="flex flex-col gap-[2rem] w-[60%] overflow-hidden">
                  ...
                  <div className="w-auto h-auto bg-white leading-6">
                    <img  className="w-[16rem] h-[13rem]" src={demo} alt="" />
                    <div className="p-[1rem] select-none">
                        <span className="flex flex-row text-[#ffff00]"><RiStarSFill /><RiStarSFill /><RiStarSFill /><RiStarSFill /><RiStarSFill /></span>
                        <h1>Name</h1>
                        <p>Price $50</p>
                    </div>
                  </div>
