    ...
    return(
        <> 
            <section className="flex flex-col items-center justify-center w-[100%] h-auto font-serif p-6 relative select-none">
                <div className="flex flex-row items-center justify-center gap-0 flex-w">
            ...
            <h1 className="absolute px-[1.8rem] py-[0.8rem] bg-[#eee2ca] border text-[1.2rem] font-semibold border-[#c8967d] bottom-[7rem]">Follow us on social media</h1>
