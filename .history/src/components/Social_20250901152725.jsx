        ...
        <> 
            <section className="flex flex-col items-center justify-center w-[100%] my-[1rem] h-auto font-serif relative select-none overflow-hidden">
                <div className="flex flex-row items-center justify-center gap-0 flex-wrap">
                    <img className="w-[15.5rem] h-[12rem]" loading="lazy" src="assets/s1.jpg" alt="youtube" />
                    <img className="w-[15.5rem] h-[12rem]" loading="lazy" src="assets/s3.jpg" alt="pinterest" />
                    <img className="w-[15.5rem] h-[12rem]" loading="lazy" src="assets/s4.jpg" alt="facebook" />
                    <img className="w-[15.5rem] h-[12rem]" loading="lazy" src="assets/s2.jpg" alt="telegram" />
                    <img className="w-[15.5rem] h-[12rem]" loading="lazy" src="assets/s5.jpg" alt="google" />
                </div>
