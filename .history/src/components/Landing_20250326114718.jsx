        ...
        <>
           ...
           <div className="relative py-[2rem] w-[100vw] h-[100vh]">
                <nav className="flex flex-row items-center justify-between px-[3rem] w-[100vw] h-[2rem]">
                    ...
                    <button className="font-bold font-serif cursor-pointer border-2 border-black px-[0.5rem] py-[0.2rem] hover:text-[#ca9379] hover:bg-black transition ">LOGIN</button>
                </nav>
           </div>
           </div>
        </>
