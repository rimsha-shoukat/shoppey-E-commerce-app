    ...
    return (
        <>
           <section className="flex flex-row max-[750px]:flex-col items-center justify-center gap-[1rem] w-[100%] h-auto py-[4rem] bg-[#251201]">
                <article className="container flex flex-col items-start justify-start gap-[1rem] max-[860px]:pl-[0.65rem] pl-[3rem] w-[30%] max-[750px]:w-[50%] max-[440px]:w-[0%] text-white">
