    ...
    return (
        <>
           <section className="flex flex-row max-[860px]:flex-col items-center justify-center gap-[3rem] w-[100%] h-auto py-[5rem] bg-[#251201]">
                <article className="container flex flex-col items-start justify-start gap-[2rem] max-[860px]:pl-[0.65rem] pl-[3rem] w-[32%] max-[1250px]:w-[50%] max-[440px]:w-[80%] text-white">
                ...
                <section className="flex flex-col gap-[2rem] w-[68%] max-[1250px]:w-[50%] max-[440px]:w-[90%] overflow-hidden">
