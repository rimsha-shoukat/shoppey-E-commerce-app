        ...
        <>
            <div className="w-[100%] flex flex-col items-center justify-center py-[3rem]">
                <section className="relative w-[50%] max-[1096px]:w-[70%] max-[710px]:w-[60%] max-[710px]:flex-col-reverse h-auto flex flex-row items-start justify-center pb-[1rem]">
                    <img  className="w-[40%] max-[710px]:w-[90%] h-[22rem] rounded-tl-[7rem]" src={collection} alt="New Collection" />
                    ...
                    <section className="absolute bottom-0 right-0 w-[70%] max-[] bg-gray-200 flex flex-row select-none p-[0.5rem] pb-[1rem]">
