...
const AllProducts = () => {
  return (
    <>
    <section className="w-screen h-auto p-0 m-0 font-serif flex flex-col items-center justify-center overflow-hidden">
    ...
    <section className="flex flex-row w-[100%] h-auto items-start justify-start gap-2 p-6">
      <section className="flex flex-col items-center justify-center w-[15%] h-auto rounded-md ring-2 ring-[#b48068] px-2">
        <button className="font-extrabold font-serif text-xl cursor-pointer hover:text-gray-500">shoppey</button>
        <button className="font-extrabold font-serif text-xl cursor-pointer hover:text-gray-500">shoppey</button>
        <button className="font-extrabold font-serif text-xl cursor-pointer hover:text-gray-500">shoppey</button>
        <button className="font-extrabold font-serif text-xl cursor-pointer hover:text-gray-500">shoppey</button>
      ...
      <section className="grid grid-cols-5 items-center gap-2 justify-center w-[75%] h-auto">
        <img className="w-[150px] h-auto" src={img1} />
        <img className="w-[150px] h-auto" src={img2} />
        <img className="w-[150px] h-auto" src={img3} />
        <img className="w-[150px] h-auto" src={img4} />
        <img className="w-[150px] h-auto" src={img5} />
        <img className="w-[150px] h-auto" src={img6} />
        <img className="w-[150px] h-auto" src={img7} />
        <img className="w-[150px] h-auto" src={img8} />
        <img className="w-[150px] h-auto" src={img9} />
        <img className="w-[150px] h-auto" src={img1} />
        <img className="w-[150px] h-auto" src={img2} />
        <img className="w-[150px] h-auto" src={img3} />
        <img className="w-[150px] h-auto" src={img4} />
