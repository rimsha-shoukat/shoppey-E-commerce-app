...
function Discount(){
    return(
        <>
        <div className="w-[100%] h-auto py-[5rem] flex flex-row max-[710px]:flex-col max-[710px]:gap-[1r] items-center justify-evenly">
            <section className='w-[25%] max-[890px]:w-[30%] h-auto bg-gray-300 p-[1rem]'>
            ...
            <section className='w-[25%] max-[890px]:w-[30%] h-auto bg-pink-500 p-[1rem] '>
            ...
            <section className='w-[25%] max-[890px]:w-[30%] h-auto bg-yellow-300 p-[1rem] '>
