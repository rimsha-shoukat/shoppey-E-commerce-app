...
function Product(){
    return(
        <>
         <div className="w-[100%] h-auto p-[rem] max-[430px]:p-[1rem] flex flex-col items-center justify-center font-serif select-none">
            ...
            <section className="w-auto h-auto flex flex-row gap-2 items-center justify-center">
                <FaAnglesLeft className="text-[2rem] p-4 text-shadow-lg cursoe-pointer" />
