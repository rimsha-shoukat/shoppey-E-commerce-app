        ...
        <>
         <div className="w-[100%] h-auto p-[3rem] max-[430px]:p-[1rem] flex flex-col items-center justify-center font-serif select-none">
            ...
            <section className="flex flex-row items-center justify-center gap-4 max-[310px]:gap-2 leading-4 w-[100%] h-[2rem] max-[430px]:text-sm">
                <button onClick={styborder-b-2} className="cursor-pointer hover:border-b-2">NEW</button>
                <button onClick={styborder-b-2} className="cursor-pointer hover:border-b-2">WOMEN</button>
                <button onClick={styborder-b-2} className="cursor-pointer hover:border-b-2">MEN</button>
                <button onClick={styborder-b-2} className="cursor-pointer hover:border-b-2">TRENDS</button>
            </section>
            {/* Product slider */}
