...
function Landing(){
    return(
        <>
           ...
           {/* Content */}
           <div className="relative flex flex-col gap-[2rem]  w-[100vw] h-[100vh]">
                <nav className="flex flex-row items-center py-[2rem] justify-between px-[3rem] w-[100vw] h-[10%]">
                ...
                <main className="flex flex-row items-center justify-between w-[100%] h-[90%]">
