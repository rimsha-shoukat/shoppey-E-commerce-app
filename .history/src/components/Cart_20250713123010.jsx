        ...
        <>
            <div className="w-[100%] h-auto font-serif flex flex-col items-center justify-between select-none">
                ...
                <section className="w-[100%] h-auto flex flex-col items-center justify-center">
                    <div className="w-[100%] flex flex-row items-center justify-between py-6 gap-[6rem] max-[600px]:gap-[3rem] border-t-2 border-t-gray-400">
                    ...
                    <div className="w-[100%] flex flex-row items-center justify-between py-6 gap-[6rem]  border-t-2 border-t-gray-400">
                        <div className="flex flex-row items-center justify-start gap-4">
                            <img className="w-[5rem] h-[5rem] rounded-sm" src={img1} />
                        <div className="flex flex-col items-start justify-start gap-2">
                            <h1 className="font-bold text-[1.2rem] leading-4">Jeans with pockets</h1>
