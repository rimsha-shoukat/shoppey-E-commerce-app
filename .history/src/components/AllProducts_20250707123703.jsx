  ...
  return (
    ...
    <section className="flex flex-row items-center justify-between p-2 w-[100%] h-auto">
        ...
        <div className="flex flex-row items-center justify-center gap-4 text-lg">
            <FaRegUser className="cursor-pointer border-none p-2 text-xl hover:bg-gray-700 rounded-full" />
            <FaCartShopping className="cursor-pointer border-none text-xl p-2 rounded-full hover:bg-gray-700" />
        </div>
    </section>
