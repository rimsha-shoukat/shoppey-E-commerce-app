        ...
        <>
            <div className="w-[100%] h-auto font-serif flex flex-col items-center justify-center gap-[2rem]">
                <section className="flex flex-row items-center py-2 px-6 justify-between w-[100%] h-auto">
                 ...
                 <section className="grid grid-cols-2 select-none items-center justify-center w-[60%] max-[1140px]:w-[70%] max-[970px]:w-[80%] max-[800px]:w-[90%] h-[30rem] border-2 border-gray-300 rounded-lg gap-[1rem] bg-[#eee2ca]">
                    <div className="cols-span-1 h-auto flex items-center justify-center">
                        <img className='w-full h-[27rem] rounded-lg' src={img1}/>
                    </div>
