                 ...
                 <section className="grid grid-cols-2 items-center justify-center w-[60%] h-auto border-2 border-gray-300 rounded-lg">
                    ...
                    <div className="cols-span-1 h-auto flex flex-col items-start justify-start p-6">
                        ...
                        <div className="flex flex-row items-center justify-center gap-[1rem]">
                            <button className="w-[1.5rem] h-[1.5rem] rounded">xs</button>
                            <button className="w-[1.5rem] h-[1.5rem] rounded">S</button>
                            <button className="w-[1.5rem] h-[1.5rem] rounded">M</button>
                            <button className="w-[1.5rem] h-[1.5rem] rounded">L</button>
                        </div>
                    </div>
                 </section>
            </div>
