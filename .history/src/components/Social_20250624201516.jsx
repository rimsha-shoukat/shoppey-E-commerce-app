        ...
        <> 
            <section className="flex flex-col items-center justify-center w-[100%] h-auto mt-6 relative select-none">
                <div className="flex flex-row items-center justify-center gap-0">
                    <img className="w-[15.rem] h-[15rem]" src={img1} alt="" />
                    <img className="w-[15.rem] h-[15rem]" src={img2} alt="" />
                    <img className="w-[15.rem] h-[15rem]" src={img3} alt="" />
                    <img className="w-[15.rem] h-[15rem]" src={img4} alt="" />
                    <img className="w-[15.rem] h-[15rem]" src={img5} alt="" />
                </div>
