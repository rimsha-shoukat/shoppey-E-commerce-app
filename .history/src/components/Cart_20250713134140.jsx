                    ...
                    <div className="w-[100%] flex flex-row items-center justify-between py-6 gap-4 border-t-2 border-t-gray-400">
                        ...
                        <div className="flex flex-row items-start justify-start gap-[6rem] max-[600px]:gap-[3rem] max-[500px]:gap-2 max-[500px]:flex-col">
                            <div className="flex flex-col items-start justify-start gap-2">
                                <h1 className="font-bold text-[1.2rem] leading-4 max-[350px]:text-md">Jeans with pockets</h1>
                                <div className="flex flex-row gap-4">
                                <p className="text-sm max-[350px]:text-xs">Size: M</p>
                                <p className="text-sm max-[350px]:text-xs">$450.98</p>
                                </div>
                            </div>
                            <div className="flex flex-row items-center justify-center gap-[1rem] max-[350px]:gap-[0.5rem]">
                                <h1 className="font-bold max-[350px]:text-sm">$901.96</h1>
                                <div className="flex flex-row item-center justify-center gap-[1rem] max-[500px]:gap-[0.5rem] border-y-2 border-white p-2 leading-4">
                                <FiMinus className="cursor-pointer hover:text-gray-700 max-[350px]:text-sm"/>
                                    <h1 className="text-[1.2rem] max-[350px]:text-sm">1</h1>
