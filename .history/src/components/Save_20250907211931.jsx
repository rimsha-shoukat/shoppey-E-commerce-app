...
const Saves = () => {
    const  = JSON.parse(localStorage.getItem('currentUser'));
    const [saveItemsList, setSaveItemsList] = useState(userData.saveItems || []);
    const [cartItems, setCartItems] = useState(userData.cartItems || []);
