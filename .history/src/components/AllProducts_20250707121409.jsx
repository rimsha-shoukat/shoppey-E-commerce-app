...
const AllProducts = () => {
  return (
    ...
    <section className="flex flex-row items-center justify-between font-serif p-4 w-[100%] h-auto">
        ...
        <section className="flex flex-col items-center font-serif p-4 justify-between w-[100%] border-none rounded-[2rem] h-auto bg-linear-to-l from-[#dd957a] to-[#eee2ca]">
           <h1 className="font-bold">Explore All Pe=roducts</h1>
            <div>
