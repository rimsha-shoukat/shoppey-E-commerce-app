...
function Deal(){
    return (
        <>
          <section className="relative w-[100%] h-[88vh] max-[1400px]:h-[75vh] max-[1170px]:h-[65vh] overflow-hidden max-[710px]:h-auto">
            {/* background */}
            ...
            <div className="relative w-[100%] h-[100%] flex flex-row max-[710px]:flex-col items-center justify-between text-[#251201]">
                ...
                <section className="w-[45%] max-[1100px]:w-[50%] max-[710px]:w-[60%] max-[460px]:w-[80%] h-[100%] flex items-end justify-end">
                    {/* img */}
                    <img className="w-[100%] h-[100%] px-[4rem] max-[900px]:pl-[2rem] max-[800px]:pr-0 max-[700px]:pl-0 overflow-hidden pt-[6rem] max-[710px]:pt-4" src={sideImg} alt="side Image" />
                </section>
            </div>
          </section>
        </>
