        ...
        <>
            <div className="w-[100%] h-auto font-serif flex flex-col items-center justify-center gap-[2rem]">
                <section className="flex flex-row items-center py-2 px-6 justify-between w-[100%] h-auto">
                 ...
                 <section className="grid grid-cols-2 select-none items-center justify-center w-[60%] max-[1140px]:w-[70%] max-[970px]:w-[80%] max-[800px] h-auto border-2 border-gray-300 rounded-lg gap-[1rem] bg-[#eee2ca]">
