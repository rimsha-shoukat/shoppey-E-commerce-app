...
const Saves = () => {
    const [saveItemsList, setSaveItemsList] = useState(J SON.parse(localStorage.getItem('SaveItems')) || []);

    useEffect(() => {
     const items = JSON.parse(localStorage.getItem('SaveItems'));
     if (items) {
      setSaveItemsList(items);
     }
    }, []);
