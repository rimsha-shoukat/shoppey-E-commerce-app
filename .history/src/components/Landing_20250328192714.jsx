    ...
    return(
        <>
           ...
           <div className="relative flex flex-col gap-[2rem] pt-[2rem] w-[100vw] h-[100vh]">
                ...
                <main className="flex flex-row max-[710px]:flex-col overflow-hidden items-center justify-between w-[100%] h-[94%]">
                    <section className="w-[50%] h-[100%] max-[710px]:h-aut flex items-center justify-center">
                    ...
                    <img className="w-[50%] h-[100%] max-[710px]:w-[90%] px-[2rem] rounded-bl-[10rem] overflow-hidden" src={sideImg} alt="side-img" />
                </main>
           </div>
           </div>
        </>
