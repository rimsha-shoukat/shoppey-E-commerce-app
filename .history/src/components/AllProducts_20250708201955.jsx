  ...
  return (
    ...
    <section className="flex flex-row w-[100%] h-auto items-start justify-start gap-4 px-4 py-6">
      ...
      <div className="columns-5 w-[82%] h-auto">
        <img className="w-full rounded-[1rem] mb-4 h-auto shadow-[1px_1px_1rem_1rem_#b48068]" src={img1} />
        <img className="w-full rounded-[1rem] mb-4 h-auto shadow-[1px_1px_1rem_1rem_#b48068]" src={img2} />
        <img className="w-full rounded-[1rem] mb-4 h-auto shadow-[1px_1px_1rem_1rem_#b48068]" src={img3} />
        <img className="w-full rounded-[1rem] mb-4 h-auto shadow-[1px_1px_1rem_1rem_#b48068]" src={img4} />
        <img className="w-full rounded-[1rem] mb-4 h-auto shadow-[1px_1px_1rem_1rem_#b48068]" src={img5} />
        <img className="w-full rounded-[1rem] mb-4 h-auto shadow-[1px_1px_1rem_1rem_#b48068]" src={img6} />
        <img className="w-full rounded-[1rem] mb-4 h-auto shadow-[1px_1px_1rem_1rem_#b48068]" src={img7} />
        <img className="w-full rounded-[1rem] mb-4 h-auto shadow-[1px_1px_1rem_1rem_#b48068]" src={img8} />
        <img className="w-full rounded-[1rem] mb-4 h-auto shadow-[1px_1px_1rem_1rem_#b48068]" src={img8} />
        <img className="w-full rounded-[1rem] mb-4 h-auto shadow-[1px_1px_1rem_1rem_#b48068]" src={img8} />
        <img className="w-full rounded-[1rem] mb-4 h-auto shadow-[1px_1px_1rem_1rem_#b48068]" src={img8} />
        <img className="w-full rounded-[1rem] mb-4 h-auto shadow-[1px_1px_1rem_1rem_#b48068]" src={img8} />
