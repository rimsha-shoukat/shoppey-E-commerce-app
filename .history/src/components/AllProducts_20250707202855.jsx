  ...
  return (
    ...
    <section className="flex flex-row w-[100%] h-auto items-start justify-start gap-2 p-6">
      ...
      <section className="grid grid-cols-5 items-center gap-2 justify-center w-[75%] h-auto">
        <img className="w-[10px] h-auto" src={img1} />
        <img className="w-[10px] h-auto" src={img2} />
        <img className="w-[10px] h-auto" src={img3} />
        <img className="w-[10px] h-auto" src={img4} />
        <img className="w-[10px] h-auto" src={img5} />
        <img className="w-[10px] h-auto" src={img6} />
        <img className="w-[10px] h-auto" src={img7} />
        <img className="w-[10px] h-auto" src={img8} />
        <img className="w-[10px] h-auto" src={img9} />
        <img className="w-[10px] h-auto" src={img1} />
        <img className="w-[10px] h-auto" src={img2} />
        <img className="w-[10px] h-auto" src={img3} />
        <img className="w-[10px] h-auto" src={img4} />
