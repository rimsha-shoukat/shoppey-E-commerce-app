...
import sideImg from "../assets/landing-side-img.jpeg";
    ...
    return(
        <>
           ...
           <div className="relative flex flex-col gap-[3rem] py-[2rem] w-[100vw] h-[100vh]">
                ...
                <main className="flex flex-row items-center justify-center gap-[7rem] w-[100%] h-[100%]">
                    ...
                    <img className="w-[30%] h-[100%] border-2 border-amber-700 rounded-bl-[10rem]" src={sideImg} alt="side-img" />
                </main>
           </div>
           </div>
        </>
