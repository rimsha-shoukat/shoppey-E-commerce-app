        ...
        <>
          <section className="relative w-[100%] h-auto">
            ...
            <div className="relative w-[100%] h-auto flex flex-row items-center justify-between">
                {/* content section */}
                <section className="flex flex-col items-start justify-center gap-6 p-[6rem] w-[50%] h-auto text-[#251201]">
                    <h1 class="text-6xl font-bold">Deal Of The Day</h1>
                    ...
                    {/* timer */}
                    <div className="flex flex-row items-start justify-between gap-10 h-auto">
