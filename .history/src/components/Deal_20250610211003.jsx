        ...
        <>
          <section className="relative w-[100%] h-auto">
            ...
            <div className="relative w-[100%] h-[100%] flex flex-row items-center justify-between text-[#251201]">
                ...
                {/* image section */}
                <section className="w-[50%] h-[100] px-[4rem] pt-[6rem]">
                    {/* img */}
                    <img className="w-[100%] h-[90%] max-[710px]:w-[70%] max-[560px]:w-[90%] max-[360px]:w-[100%] px-[2rem] overflow-hidden" src={sideImg} alt="side Image" />
                </section>
            </div>
          </section>
        </>
