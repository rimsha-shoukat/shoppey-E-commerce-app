        ...
        <>
          <section className="relative w-[100%] h-[88vh] overflow-hidden max-[710px]:h-auto">
            ...
            <div className="relative w-[100%] h-[100%] flex flex-row max-[710px]:flex-col items-center justify-between text-[#251201]">
                {/* content section */}
                <section className="flex flex-col items-start justify-center gap-4 pl-[4rem] max-[800px]:pl-[2rem] w-[50%] max-[710px]:w-[60%] max-[710px]:pt-4 h-auto select-none font-serif">
                ...
                <section className="w-[45%] max-[900px]:w-[50%] max-[710px]:w-[60%] h-[100%] flex items-end justify-end">
                    {/* img */}
                    <img className="w-[100%] h-[100%] px-[4rem] max-[800px]:pl-[2rem] max-[800px]:pr-0 max-[700px]:p overflow-hidden pt-[6rem] max-[710px]:pt-4" src={sideImg} alt="side Image" />
                </section>
            </div>
          </section>
        </>
