        ...
        <>
         <div className="w-[100%] h-auto p-[4rem] flex flex-col items-center justify-center font-serif select-none">
            ...
            <section className="flex flex-row items-center justify-center gap-4 leading-4">
                <button className="cursor-pointer hover:border-b-2 hove">NEW</button>
                <button className="cursor-pointer hover:border-b-2 hove">WOMEN</button>
                <button className="cursor-pointer hover:border-b-2 hove">MEN</button>
                <button className="cursor-pointer hover:border-b-2 hove">TRENDS</button>
