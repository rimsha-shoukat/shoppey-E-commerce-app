    ...
    return (
        <>
           <section className="flex flex-row max-[976px]:flex-col items-center justify-center gap-[1rem] w-[100%] h-auto py-[4rem] bg-[#251201]">
                <article className="container flex flex-col items-start justify-start gap-[1rem] pl-[3rem] w-[30%] text-white">
                    <h1 className="text-6xl text-wrap:no-wrap font-bold select-none">Best Seller <br/> Item</h1>
