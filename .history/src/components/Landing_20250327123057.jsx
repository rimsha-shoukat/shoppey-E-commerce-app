    ...
    return(
        <>
           ...
           <div className="relative flex flex-col gap-[2rem] py-[2rem] w-[100vw] h-[100vh]">
                <nav className="flex flex-row items-center justify-between px-[3rem] w-[100vw] h-[2.rem]">
                ...
                <main className="flex flex-row items-center justify-center w-[100%] h-auto">
                    ...
                    <img className="w-[43%] max-h-[85vh] rounded-bl-[10rem]" src={sideImg} alt="side-img" />
                </main>
           </div>
           </div>
        </>
