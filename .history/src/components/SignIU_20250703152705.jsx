...
function SignIU(){
    ...
    return(
        ...
        <main className="relative flex flex-row-reverse max-[800px]:flex-col items-center justify-center w-[100%] h-[100vh] select-none font-serif">
            ...
            <section className="absolute -left-[10.5rem] max-[800px]:left-[2rem] max-[800px]:bottom-[5rem] max-[440px]:left-[2.5re] w-[22rem] h-[26rem] bg-[#eee2ca] rounded-xl border-0 shadow-xl  z-4">
