    ...
    return(
        <>
         <div className="w-[100%] h-auto p-[3rem] max-[430px]:p-[1rem] flex flex-col items-center justify-center font-serif select-none">
            ...
            {/* Product slider */}
            <section className="w-auto h-auto flex flex-row gap-2 items-center justify-center p-2">
                <FaAnglesLeft className="text-[1.5rem]  cursor-pointer" />
                <div className="grid grid-rows-2 gap-2 mt-6 inset-shadow-sm inset-shadow-indigo-500 overflow-hidden w-auto">
