...
const AllProducts = () => {
  return (
    <>
    <section className="w-screen h-auto p-0 m-0 font-serif flex flex-col items-center justify-center overflow-x-hidden">

    <div className="flex flex-row items-center py-2 px-6 justify-between w-full h-auto">
        <Link to="/">
    ...
    <div className="flex flex-col items-center justify-center w-full p-6 h-auto bg-linear-to-l from-[#dd957a] to-[#eee2ca] gap-2">
    ...
    <section className="flex flex-row w-[100%] h-auto items-start justify-start gap-2 px-2 py-6">
      ...
      <section className="columns-6 w-[75%] h-auto">
