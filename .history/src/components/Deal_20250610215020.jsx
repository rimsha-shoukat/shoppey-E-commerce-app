...
function Deal(){
    return (
        <>
          <section className="relative w-[100%] h-[100v]">
            {/* background */}
            ...
            <div className="relative w-[100%] h-[100%] flex flex-row items-center justify-between text-[#251201]">
                ...
                {/* image section */}
                <section className="w-[50%] h-[100%] flex items-center justify-end">
                    {/* img */}
                    <img className="w-[100%] h-[90%] px-[4rem] overflow-hidden max-[1100px]:px-[2rem]" src={sideImg} alt="side Image" />
                </section>
            </div>
          </section>
        </>
