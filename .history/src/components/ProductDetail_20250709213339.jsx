                 ...
                 <section className="grid grid-cols-2 select-none items-center justify-center w-[60%] h-auto border-2 border-gray-300 rounded-lg gap-[1rem] bg-[#eee2ca]">
                    ...
                    <div className="cols-span-1 h-auto flex flex-col items-start justify-start p-6">
                        ...
                        <div className="flex flex-row items-center justify-center gap-[1rem] mb-6">
                            <button className="w-[2.5rem] h-[2.5rem] rounded-full shadow-[0.3px_0.5px_0.3px] cursor-pointer">XS</button>
                            <button className="w-[2.5rem] h-[2.5rem] rounded-full shadow-[0.3px_0.5px_0.3px] cursor-pointer">S</button>
                            <button className="w-[2.5rem] h-[2.5rem] rounded-full shadow-[0.3px_0.5px_0.3px] cursor-pointer">M</button>
                            <button className="w-[2.5rem] h-[2.5rem] rounded-full shadow-[0.3px_0.5px_0.3px] cursor-pointer">L</button>
                        </div>
