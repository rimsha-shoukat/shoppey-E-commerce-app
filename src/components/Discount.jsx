...
function Discount() {
    ...
    return (
        <>
        {/* map discounts */}
            <div className="w-full h-auto py-[5rem] max-[710px]:pt-[5rem] max-[710px]:pb-0 flex flex-row overflow-y-hidden overflow-x-scroll [scrollbar-width:none] max-[710px]:flex-col max-[710px]:gap-[1rem] items-center justify-evenly">
                {
